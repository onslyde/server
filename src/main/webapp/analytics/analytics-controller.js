...
//                      document.getElementById('chart-movie-frame').src = 'http://www.youtube.com/v/' + $rootScope.sessionData.sessionCode + '?version=3&autoplay=1&start=' + ((this.category - startTime) / 1000);
      ...
      $scope.getPanelist = function(sessionID, name) {
        ...
        var allpanels =
        [
            {name:'Natasha Rooney', org:'GSMA', pic:'http://edgeconf.com/images/heads/natasha-rooney.jpg', twitter:'thisnatasha', mod:true},
            {name:'Manu Sporny', org:'Digital Bazaar', pic:'http://edgeconf.com/images/heads/manu-sporny.jpg', twitter:'manusporny'},
            {name:'Rob Grimshaw', org:'FT.com', pic:'http://edgeconf.com/images/heads/rob-grimshaw.jpg', twitter:'r_g'},
            {name:'Cyndy Lobb', org:'Google', pic:'http://edgeconf.com/images/heads/cyndy-lobb.jpg', twitter:''},
            {name:'Ricardo Varela', org:'Telefónica', pic:'http://edgeconf.com/images/heads/ricardo-varela.jpg', twitter:'phobeo'},
            {name:'Kumar McMillan', org:'Mozilla', pic:'http://edgeconf.com/images/heads/kumar-mcmillan.jpg', twitter:'kumar303'},

            {name:'Marcos Caceres', org:'Mozilla', pic:'http://edgeconf.com/images/heads/marcos-caceres.jpg', twitter:'marcosc', mod:true},
            {name:'Yoav Weiss', org:'WL Square', pic:'http://edgeconf.com/images/heads/yoav-weiss.jpg', twitter:'yoavweiss'},
            {name:'Ann Robson', org:'freelance', pic:'http://edgeconf.com/images/heads/ann-robson.jpg', twitter:'arobson'},
            {name:'Estelle Weyl', org:'freelance', pic:'http://edgeconf.com/images/heads/estelle-weyl.jpg', twitter:'estellevw'},
            {name:'Peter Miller', org:'Conde Nast', pic:'http://edgeconf.com/images/heads/peter-miller.jpg', twitter:'petemill'},
            {name:'John Mellor', org:'Google', pic:'http://edgeconf.com/images/heads/john-mellor.jpg', twitter:''},

            {name:'Andre Behrens', org:'The New York Times', pic:'http://edgeconf.com/images/heads/andre-behrens.jpg', twitter:'mrandre', mod:true},
            {name:'Jonathan Klein', org:'Etsy', pic:'http://edgeconf.com/images/heads/jonathan-klein.jpg', twitter:'jonathanklein'},
            {name:'Paul Lewis', org:'Google', pic:'http://edgeconf.com/images/heads/paul-lewis.jpg', twitter:'aerotwist'},
            {name:'Ariya Hidayat', org:'Sencha', pic:'http://edgeconf.com/images/heads/ariya-hidayat.jpg', twitter:'ariyahidayat'},
            {name:'Joshua Peek', org:'Github', pic:'http://edgeconf.com/images/heads/joshua-peek.jpg', twitter:'joshpeek'},
            {name:'Eli Fidler', org:'BlackBerry', pic:'http://edgeconf.com/images/heads/eli-fidler.jpg', twitter:'efidler'},

            {name:'Scott Jenson', org:'Jenson Design', pic:'http://edgeconf.com/images/heads/scott-jenson.jpg', twitter:'scottjenson', mod:true},
            {name:'Martyn Loughran', org:'Pusher', pic:'http://edgeconf.com/images/heads/martyn-loughran.jpg', twitter:'mloughran'},
            {name:'Wesley Hales', org:'Apigee', pic:'http://edgeconf.com/images/heads/wesley-hales.jpg', twitter:'wesleyhales'},
            {name:'Rob Hawkes', org:'freelance', pic:'http://edgeconf.com/images/heads/rob-hawkes.jpg', twitter:'robhawkes'},
            {name:'John Fallows', org:'Kaazing', pic:'http://edgeconf.com/images/heads/john-fallows.jpg', twitter:''},
            {name:'Henrik Joretag', org:'&yet', pic:'http://edgeconf.com/images/heads/henrik-joretag.jpg', twitter:'HenrikJoreteg'},

            {name:'Paul Irish', org:'Google', pic:'http://edgeconf.com/images/heads/paul-irish.jpg', twitter:'paul_irish', mod:true},
            {name:'Tom Maslen', org:'BBC', pic:'http://edgeconf.com/images/heads/tom-maslen.jpg', twitter:'tmaslen'},
            {name:'Tomomi Imura', org:'Nokia', pic:'http://edgeconf.com/images/heads/tomomi-imura.jpg', twitter:'girlie_mac'},
            {name:'Shwetank Dixit', org:'Opera', pic:'http://edgeconf.com/images/heads/shwetank-dixit.jpg', twitter:'shwetank'},
            {name:'Edd Sowden', org:'Government Digital Service', pic:'http://edgeconf.com/images/heads/edd-sowden.jpg', twitter:'edds'},

            {name:'Steve Thair', org:'Seriti Consulting', pic:'http://edgeconf.com/images/heads/steve-thair.jpg', twitter:'theopsmgr', mod:true},
            {name:'Ben Vinegar', org:'Disqus', pic:'http://edgeconf.com/images/heads/ben-vinegar.jpg', twitter:'bentlegen'},
            {name:'Guy Podjarny', org:'Akamai', pic:'http://edgeconf.com/images/heads/guy-podjarny.jpg', twitter:'guypod'},
            {name:'Stoyan Stefanov', org:'Facebook', pic:'http://edgeconf.com/images/heads/stoyan-stefanov.jpg', twitter:'stoyanstefanov'},
            {name:'Barbara Bermes', org:'CBC', pic:'http://edgeconf.com/images/heads/barbara-bermes.jpg', twitter:'bbinto'},

            {name:'Jake Archibald', org:'Google', pic:'http://edgeconf.com/images/heads/jake-archibald.jpg', twitter:'jaffathecake', mod:true},
            {name:'Alex Russell', org:'Google', pic:'http://edgeconf.com/images/heads/alex-russell.jpg', twitter:'slightlylate'},
            {name:'Matt Andrews', org:'FT Labs', pic:'http://edgeconf.com/images/heads/matt-andrews.jpg', twitter:'andrewsmatt'},
            {name:'Craig Cavalier', org:'LiquidFrameworks', pic:'http://edgeconf.com/images/heads/craig-cavalier.jpg', twitter:'CraigCav'},
            {name:'Calvin Spealman', org:'Caktus Consulting', pic:'http://edgeconf.com/images/heads/calvin-spealman.jpg', twitter:'ironfroggy'}
          ];
